...
const Chatbox = ({ selectedUserId, onBack }) => {
  ...
  return (
    <div className={`flex flex-col flex-1 w-full min-w-0 overflow-hidden ${pathname === "/messages" ? "sm:max-h-[100vh] max-h-[calc(100vh-4rem)]" : "max-h-[94.5vh]" }`} style={{height: "100%", overflowY: "hidden",}}>
      ...
      <div id="chat-container" className="flex-1 overflow-y-auto no-scrollbar w-full min-w-0 pb-4 px-4 md:px-8 scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200" style={{overflowX: "hidden"}}>
