    ...
    <div className='min-h-screen flex flex-col md:flex-row'>
      ...
      <div className='flex-1 flex flex-col xl:items-start items-center justify-between p-6 md:p-10 lg:pl-40'>
        ...
        <div>
          ...
          <h1 className='text-3xl md:text-6xl md:pb-2 font-bold bg-gradient-to-r from-indigo-950 to-indigo-800 bg-clip-text text-transparent'>Connect. Share. Inspire. All in One Link.</h1>
          <p className='text-xl md:text-3xl text-indigo-900 max-w-72 md:max-w-md'>One Platform. Endless Connections — SHARP LINK</p>
        </div>
